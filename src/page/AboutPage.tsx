            ...
            <div className="about-wrapper-1">
              ...
              <div className="about-side-2">
                ...
                <p className="paragraph-text-1">
                  ...
                  identity in my spare time and at work. I am creative thinker
                  and enjoy about new tools and approaches to enhance my design
            ...
            <div className="about-content-wrapper">
              ...
              <ul className="content-items">
                <li className="content-item">
                  I love to discover new ideas and opportunities. The main
                  reason why I decided to become a UI/UX designer was that I
                  felt that it is a part of my personality which will bring up
                  change. In the future, I want to work on different projects
                  under different conditions and in different industries around
                  the world which is challenging yet fun at the same time.
                </li>

                <li className="content-item">
                  I believe that good UI can make user experience very easy, and
                  better experience will lead to more happy customers. So, I
                  want to create a design that is not only beautiful and
                  elegant, but also useful for users.
                </li>

                <li className="content-item">
                  I believe that professional design is a collaborative process.
                  I believe that UX designers must work with others to design
                  the best user experience possible. I practice empathy and deep
                  understanding of the user's problems and goals when designing
                  a product.
                </li>
              </ul>
            </div>
